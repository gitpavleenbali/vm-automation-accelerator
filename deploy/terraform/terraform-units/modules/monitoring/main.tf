 ...
 * 
 * Purpose:
 *   - Deploys Azure Monitor Agent (AMA) to VMs
 *   - Deploys Dependency Agent for VM Insights
 *   - Configures Data Collection Rules (DCR) for performance and logs
...
#=============================================================================
# DEPENDENCY AGENT - Windows (For VM Insights)
#=============================================================================
...
#=============================================================================
# DEPENDENCY AGENT - Linux (For VM Insights)
#=============================================================================
...
#=============================================================================
# DATA COLLECTION RULE (DCR) - Performance and Event Logs
#=============================================================================
...
resource "azurerm_monitor_data_collection_rule" "vm_dcr" {
  ...
  # Windows Performance Counters Data Flow
  dynamic "data_flow" {
  ...
  # Windows Performance Counter Data Sources
  ...
  # Windows Event Log Data Sources
  dynamic "data_sources" {
    for_each = var.os_type == "Windows" && var.enable_event_logs ? [1] : []
    content {
      windows_event_log {
